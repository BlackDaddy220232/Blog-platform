...
public class AuthorService {
  ...
  /**
   * Creates a new article with the given title and associates it with the
   * author having the provided nickname.
   *
   ...
   * @throws ArticleNotFoundException If the article with the given title already exists.
   */
  ...
  /**
   * Deletes the article with the given title, associated with the author
   * having the provided nickname.
   *
  ...
  /**
   * Changes the title of an article associated with the author having the
   * provided nickname.
   *
   ...
   * @throws ArticleNotFoundException If the article with the given old title does not exist,
   *                                 or if the new title already exists.
   */
